 ...
 *         TLS (SpeakStarttls)
 */
public class SendStarttlsCommandAction extends SendAsciiAction {

    public SendStarttlsCommandAction(String asciiString, String encoding) {
        super(asciiString, encoding);
    }

    public SendStarttlsCommandAction(String encoding) {
        super(encoding);
    }
}
